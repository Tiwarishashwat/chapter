...
<body background="wall.png">
   <nav style="position:fixed;background-color:#0B9444;width:100%;top:0;left:0;">
      <ul style="list-style-type:none;">
        ...
        <center>
        <li style="margin-left:350px;"><a href="home.php" class="current">HOME</a></li>
...
<div class="bg-text">
  <h1 class="wow pulse">WELCOME TO ST COMMUNICATIONS</h1>
  <h2 class="wow fadeIn">click on the button below to get started</h2>
